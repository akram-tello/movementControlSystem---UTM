<?php include('constatnt/head.php'); ?>
<body>
	<nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse p-0">
		<div class="container">
			...
			<a href="index.php" class="navbar-brand mr-3">UTM Movement Control System</a>
	...
	<header id="main-header" class="bg-danger py-2 text-white">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1><i class="fa fa-user-secret"></i> Principal Login</h1>
				</div>
			</div>
		</div>
	</header>
